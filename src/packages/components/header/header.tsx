                ...
                <div className="main__header--inner d-flex justify-content-between align-items-center">
                    ...
                    <div className="main__logo">
                        <h1 className="main__logo--title"><a className="main__logo--link" href="index.html">
                            <img className="main__logo--img" src="https://ramyanagendra.com/cdn/shop/files/RN_Logo_1_1.png?v=1724335030&width=300" alt="logo-img" />
                        </a></h1>
                    </div>
                            ...
                            <ul className="header__menu--wrapper d-flex">
                                <li className="header__menu--items">
                                    ...
                                    <ul className="header__sub--menu">
                                        <li className="header__sub--menu__items"><a href="index.html" className="header__sub--menu__link">Home - Beauty Cosmetic</a></li>
                                        <li className="header__sub--menu__items"><a href="index-2.html" className="header__sub--menu__link">Home - Cosmetic Spa</a></li>
                                        <li className="header__sub--menu__items"><a href="index-3.html" className="header__sub--menu__link">Home - Jewelry Store</a></li>
                                        <li className="header__sub--menu__items"><a href="index-4.html" className="header__sub--menu__link">Home -  Modern Jewelry</a></li>
                                        <li className="header__sub--menu__items"><a href="index-5.html" className="header__sub--menu__link">Home - Look book</a></li>
                                        <li className="header__sub--menu__items"><a href="index-6.html" className="header__sub--menu__link">Home - Beauty Jewelers</a></li>
                                        <li className="header__sub--menu__items"><a href="index-7.html" className="header__sub--menu__link">Home - Parallax</a></li>
                                    </ul>
                                </li>
                                        ...
                                        <ul className="header__mega--menu d-flex">
                                            <li className="header__mega--menu__li">
                                                <ul className="header__mega--sub__menu">
                                                    ...
                                                    <li className="header__mega--sub__menu_li"><a className="header__mega--sub__menu--title" href="shop.html">Vitamins & Health</a></li>
                                                    <li className="header__mega--sub__menu_li"><a className="header__mega--sub__menu--title" href="shop.html">Mans Collection</a></li>
                                                    <li className="header__mega--sub__menu_li"><a className="header__mega--sub__menu--title" href="shop.html">Beauty products</a></li>
                                                </ul>
                                            </li>
                                            <li className="header__mega--menu__li">
                                                <ul className="header__mega--sub__menu">
                                ...
                                <li className="header__menu--items">
                                    <a className="header__menu--link" href="shop.html">Accesories </a>  
                                </li>
                                <li className="header__menu--items">
                                    ...
                                    <ul className="header__sub--menu">
                                        <li className="header__sub--menu__items"><a href="blog-grid.html" className="header__sub--menu__link">Blog Grid</a></li>
                                        <li className="header__sub--menu__items"><a href="blog-details.html" className="header__sub--menu__link">Blog Details</a></li>
                                        <li className="header__sub--menu__items"><a href="blog.html" className="header__sub--menu__link">Blog Left Sidebar</a></li>
                                ...
                                <li className="header__menu--items">
                                    <a className="header__menu--link active" href="#">Pages 
                                        <svg className="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                        </svg>
                                    </a>
                    ...
                    <ul className="offcanvas__menu_ul">
                        <li className="offcanvas__menu_li">
                            ...
                            <ul className="offcanvas__sub_menu">
                                <li className="offcanvas__sub_menu_li"><a href="index.html" className="offcanvas__sub_menu_item">Home - Beauty Cosmetic</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-2.html" className="offcanvas__sub_menu_item">Home - Cosmetic Spa</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-3.html" className="offcanvas__sub_menu_item">Home - Jewelry Store</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-4.html" className="offcanvas__sub_menu_item">Home - Modern Jewelry</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-5.html" className="offcanvas__sub_menu_item">Home - Look book</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-6.html" className="offcanvas__sub_menu_item">Home - Beauty Jewelers</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-7.html" className="offcanvas__sub_menu_item">Home - Parallax</a></li>
                            </ul>
                        </li>
                        <li className="offcanvas__menu_li">
