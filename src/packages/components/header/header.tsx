                                    ...
                                    <li className="header__menu--items">
                                        ...
                                        <ul className="header__sub--menu">
                                            <li className="header__sub--menu__items">
                                                <Link className="header__sub--menu__link" to={{
                                                    pathname: "/"
                                                }}>
                                                    Home - Beauty Cosmetic</Link></li>
                                        </ul>
                                    </li>
                                            ...
                                            <ul className="header__mega--menu d-flex">
                                                ...
                                                <li className="header__mega--menu__li banner__child">
                                                    <div className="header__mega--menu__banner">
                                                        <a href="shop.html">
                                                            <img className="header__mega--menu__banner--img" src="https://ramyanagendra.com/cdn/shop/files/IMG-20241102-WA0005.jpg?v=1730523831&width=360" alt="banner" />
                                                        </a>
                                                    </div>
                                                </li>
                                            </ul>
            ...
            <div className="offcanvas__sticky--toolbar">
                <ul className="d-flex justify-content-between">
                    ...
                    <li className="offcanvas__sticky--toolbar__list">
                        ...
                        <Link className="__sticky--toolbar__btn search__open--btn" to={{
                            pathname: "/"
                        }}>
                            <span className="offcanvas__sticky--toolbar__icon">
                    ...
                    <li className="offcanvas__sticky--toolbar__list">
                        ...
                        <Link className="offcanvas__sticky--toolbar__btn minicart__open--btn" to={{
                            pathname: "/"
                        }}>
                            <span className="offcanvas__sticky--toolbar__icon">
